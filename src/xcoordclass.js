import { indexOfLastMinElementInArray, printObject } from './helpers';
import { TYPE } from './baseGraph';

/*
 * xinit: coordinates of _center_ of every vertex, or null
 */
export function XCoord(xinit, graph)
{
...
export function XCoordScore(maxRealVertexId) {
  this.score           = 0;
  this.inEdgeMaxLen    = [];
...
export function VerticalLevels() {
