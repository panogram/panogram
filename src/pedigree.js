...
import { NodetypeSelectionBubble } from "./nodetypeSelectionBubble";
import { Workspace } from "./workspace";
import { OkCancelDialogue } from "./okCancelDialogue";
...
import { SaveLoadEngine, ProbandDataLoader } from "./saveLoadEngine";
 ...
 * @constructor
 */
export const PedigreeEditor = Class.create({
    initialize: function() {
        //this.DEBUG_MODE = true;
        window.editor = this;

        // initialize main data structure which holds the graph structure
        this._graphModel = DynamicPositionedGraph.makeEmpty(PedigreeEditorAttributes.layoutRelativePersonWidth, PedigreeEditorAttributes.layoutRelativeOtherWidth);
        ...
        unsupportedBrowserButton && unsupportedBrowserButton.on("click", function(event) {
            console.warn("Your browser does not support all the features required for " +
