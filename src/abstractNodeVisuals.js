...
export const AbstractNodeVisuals = Class.create({
...
export const ChildlessBehaviorVisuals = {
  ...
  updateChildlessShapes: function() {
    ...
    if(status) {
      var x    = this.getX();
      var y    = this.getY();
      var r    = PedigreeEditorAttributes.infertileMarkerWidth;
      var lowY = this.getBottomY() + PedigreeEditorAttributes.infertileMarkerHeight;
