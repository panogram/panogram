...
import { stringifyObject, Timer, arrayContains } from "./helpers";
import { PedigreeEditorAttributes } from "./pedigreeEditorAttributes";
import { drawCornerCurve, drawLevelChangeCurve } from "./graphicHelpers";
...
export const View = Class.create({
    ...
    drawCurvedLineWithCrossings: function ( id, xFrom, yFrom, yTop, xTo, yTo, lastBend, attr, twoLines, secondLineBelow ) {
        ...
        var cornerRadius     = PedigreeEditorAttributes.curvedLinesCornerRadius * 0.8;
